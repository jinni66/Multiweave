...
datasets = {
    ...
    'syn1': (X_train_net_scaled, y_train_net),
    'syn2': (X_train_our_scaled, y_train_our)
}
...
for dataset_name, (X_train_scaled, y_train) in datasets.items():
    for model_name, model in models_dict.items():
        ...
        print(f"Done {dataset_name} - {model_name}", flush=True)
